...
# pokemon_red baseline benchmark: all tasks, single_none executor, vLLM Qwen2.5-VL-32B-AWQ
# Save video enabled. Followed by debug_benchmark to write episode MD + comparison.
#
# Submit:
#   qsub -l gpu=1,h_vmem=80G,h_rt=86400 -j y -cwd scripts/run_benchmark_vllm_pokemon_red.sh
