...
#
# Submit:
#   qsub -l gpu=1,h_vmem=80G,h_rt=86400 -j y -cwd scripts/run_strategist_prism.sh
...
MAX_TASKS=4       # portability probe, not a goal attempt
MAX_STEPS=60
...
echo ""
echo "=== STRATEGIST PORTABILITY TEST: pokemon_prism (screen-only parser) ==="
