...
ITERATIVE_TRAINING_DEFAULTS["n_agents"]=4
...
CREATE_TRAJ_DEFAULTS["z_min"]=3.0

CREATE_TRAJ_ARG_KEYS=("${CREATE_TRAJ_ESSENTIALS[@]}" "${!CREATE_TRAJ_DEFAULTS[@]}")

CREATE_DATASET_ESSENTIALS=("model_name" "vlm_kind" "init_state_group" "run_name")
declare -A CREATE_DATASET_DEFAULTS
populate_array ESSENTIAL_ARGS CREATE_DATASET_ESSENTIALS
populate_dict ALL_DEFAULTS CREATE_DATASET_DEFAULTS
