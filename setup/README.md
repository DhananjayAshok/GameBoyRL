...
```console
uv add click huggingface_hub
```
These two packages are required for this codebase to run, but you can remove the `huggingface_hub` dependency by removing [`sync_data.py`](../sync_data.py).
