...
for model in "${models[@]}"; do
    ...
    #bash scripts/benchmark.sh --game $game --executor_vlm_model "$model" --executor_vlm_kind huggingface
    ...
    #bash scripts/benchmark.sh --game $game --executor_vlm_model "$model_name" --executor_vlm_kind huggingface --regenerate true --max_steps 75
done
