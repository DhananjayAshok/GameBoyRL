...
for model in "${models[@]}"; do
    ...
    bash runs/benchmark.sh --game $game --executor_vlm_model "$train_model" --executor_vlm_kind huggingface --regenerate true
    ...
    bash runs/benchmark.sh --game $game --executor_vlm_model "$model_name" --executor_vlm_kind huggingface --regenerate true
done
