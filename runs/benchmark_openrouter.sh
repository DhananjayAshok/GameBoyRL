...
games=("deja_vu_1" "deja_vu_2" "harvest_moon_1" "harvest_moon_2" "harvest_moon_3" "bomberman_pocket" "bomberman_quest" "bomberman_max")
...
for game in "${games[@]}"; do
    ...
    for model in "${models[@]}"; do
        ...
        bash runs/benchmark.sh --game $game --executor_vlm_model "$model" --executor_vlm_kind openrouter --max_steps 2
    done
done